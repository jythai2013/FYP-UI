...
var _fs, jszip;
		// _fs = require('f'+'s'); //original syntax but originally not here
		if(Meteor.isServer){
			_fs = Npm.require('f'+'s'); //meteor built in
			// console.log(_fs);
			// _fs = Meteor.npmRequire('f'+'s'); //meteorhacks:npm
			// console.log(_fs);
			// if(_fs != undefined) console.log("not undefined");
		} 
if(typeof JSZip !== 'undefined') jszip = JSZip;
if (typeof exports !== 'undefined') {
	if (typeof module !== 'undefined' && module.exports && Meteor.isServer) {
...
// if (Meteor.isServer) {
  // Meteor.methods({
    // 'getGists': function getGists(user) {
      // var GithubApi = Meteor.npmRequire('fs');
...
// if (Meteor.isClient) {
  // _fs = function getGists(user, callback) {
